...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Chỉnh sửa nhà xuất bản: <span class="text-primary">{{ $publisher->name }}</span></h1>
            ...
            <div class="card shadow mb-4 border-0 rounded-lg">
                ...
                <div class="card-header py-3 bg-white">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas id-card mr-2"></i> Điền thông tin nhà xuất bản muốn cập nhật
                    </h6>
                </div>
                    ...
                    <form action="{{ route('admin.publishers.update', $publisher->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success px-4 font-weight-bold shadow-sm">
                                <i class="fas fa-save mr-1"></i> Cập nhật nhà xuất bản
                            </button>
                        </div>
