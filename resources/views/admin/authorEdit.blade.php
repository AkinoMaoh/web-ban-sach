...
@section('admin_content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Trang sửa tác giả</h1>
                   <div class="card-body">
                            <a href="{{ route('admin.authors') }}" class="btn btn-success mb-3">Quay lại</a>
                        <div class="card-body">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Điền thông tin tác giả muốn sửa</h6>
                        </div>
                            <div class="card-body">
                                <form action="{{ route('admin.authors.update', $author->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="bio" name="bio">{{ old('bio', $author->bio) }}</textarea>
                                    </div>
