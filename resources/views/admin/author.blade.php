...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Quản lý tác giả</h1>
        <a href="{{ route('admin.authorAdd') }}" class="btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50 mr-1"></i> Thêm tác giả mới
        </a>
    </div>
                    ...
                    <tbody>
                        @forelse ($authors as $author)
                            ...
                            <tr class="clickable-row" data-href="{{ route('admin.authors.edit', $author->id) }}" style="cursor: pointer;" title="Nhấn để sửa">
                                ...
                                <td>
                                    <span class="font-weight-bold text-dark">{{ $author->name }}</span>
                                </td>
                                ...
                                <td class="text-center pr-4">
                                    <div class="d-inline-flex align-items-center justify-content-center">
                                        ...
                                        <a href="{{ route('admin.authors.destroy', $author->id) }}" 
                                           ...
                                           onclick="event.stopPropagation(); return confirm('Bạn có chắc chắn muốn xóa tác giả này?')" 
                                           title="Xóa">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-4">Không tìm thấy tác giả nào.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
