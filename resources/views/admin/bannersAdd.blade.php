...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Thêm Banner mới</h1>
        ...
        <div class="card shadow mb-4 border-0 rounded-lg">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control"
                                      rows="3"
                                      name="description"
                                      placeholder="Nhập mô tả ngắn cho banner...">{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="col-lg-4 text-center border-left">
                        <label class="font-weight-bold text-dark d-block text-left mb-2">Hình ảnh Banner <span class="text-danger">*</span></label>
                        
                        <div class="mb-3">
                            <img id="preview"
                                 src="https://placehold.co/350x200?text=Banner+Preview"
            ...
            <div class="card-footer bg-white py-3 d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary px-4 font-weight-bold">
                    <i class="fas fa-plus-circle mr-1"></i> Thêm Banner
                </button>
            </div>
