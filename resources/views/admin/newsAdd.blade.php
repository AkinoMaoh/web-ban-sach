...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Thêm tin tức mới</h1>
    ...
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <!-- CỘT TRÁI: Nội dung chi tiết tin tức -->
            <div class="col-lg-8">
                <div class="card shadow mb-4 border-0 rounded-lg">
                    <div class="card-header py-3 bg-white">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-info-circle mr-2"></i> Thông tin tin tức</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2">
                            <label for="content" class="font-weight-bold text-dark">Nội dung chi tiết <span class="text-danger">*</span></label>
            ...
            <!-- CỘT PHẢI: Hình ảnh, Trạng thái, Nổi bật & Nút lưu -->
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4 border-0 rounded-lg">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img id="preview"
                                 src="https://placehold.co/350x200?text=News+Preview"
                ...
                <!-- Thẻ Cấu hình hiển thị & Nút hành động -->
                <div class="card shadow mb-4 border-0 rounded-lg sticky-top" style="top: 20px;">
                    <div class="card-header py-3 bg-white">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-cog mr-2"></i> Cài đặt & Đăng bài</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column">
                            <button type="submit" class="btn btn-primary btn-block py-2 font-weight-bold shadow-sm mb-2">
                                <i class="fas fa-plus-circle mr-1"></i> Thêm tin tức
                            </button>
