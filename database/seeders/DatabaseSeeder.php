...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            ...
            ['id' => 55, 'category_id' => 4, 'author_id' => 3, 'publisher_id' => 2, 'name' => 'Chuyện Con Chó Tên Là Trung Thành', 'description' => 'Tác phẩm cảm động về lòng trung thành của một chú chó chăn cừu.', 'price' => 55000.00,  'image' => 'con_cho_trung_thanh.jpg', 'status' => 1],
